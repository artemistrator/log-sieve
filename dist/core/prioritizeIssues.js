...
function compareIssues(left, right) {
    const priorityDifference = priorityOrder[right.priority ?? "low"] - priorityOrder[left.priority ?? "low"];
    ...
    const columnDifference = (left.column ?? Number.MAX_SAFE_INTEGER) - (right.column ?? Number.MAX_SAFE_INTEGER);
